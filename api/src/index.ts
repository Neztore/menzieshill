...
// TODO: Set CORS
app.use(cors({ //
  origin: ["localhost", "http://localhost", "https://localhost", "new.menzieshillwhitehall.co.uk", "api.menzieshillwhitehall.co.uk", "https://api.menzieshillwhitehall.co.uk", "https://new.menzieshillwhitehall.co.uk"],
  credentials: true
}));
app.options('*', cors())
