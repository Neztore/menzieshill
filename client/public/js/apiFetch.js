const Api = {};
// Guess at whether it's localhost or backend.
const BaseUrl = window.BaseUrl || window.location.href.includes("menzieshill") ? "https://api.menzieshillwhitehall.co.uk" : "http://localhost:3000";
Api.BaseUrl = BaseUrl;
