...
export const Editor: FunctionComponent<EditorProps> = function ({setContent, content}) {
  return <Fragment>
    ...
    <p>The first "big" title (#) will specify the page title, while <code>desc:Page description</code> can be used to specify page description.
    These values are used for the meta tags (visible to Search engines and when the link is used on social media)
    </p>
    <p>You should take care when editing any HTML code here as it is likely part of the original site and you may have an adverse affect on page layout.
